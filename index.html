...
<!--[if gt IE 8]><!--> <html class="no-js" > <!--<![endif]-->
	<head>
		...
		<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/minnojs/minno-quest@0.1/dist/styles/main.css" />
	...
	<![endif]-->
    <script src="//cdn.jsdelivr.net/gh/minnojs/minno-quest@0.1/dist/js/bootstrap.js" type="text/javascript"></script>
</html>
